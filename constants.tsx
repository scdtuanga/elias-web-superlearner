...
export const LEARNING_SKILLS: LearningSkill[] = [
  {
    title: 'Reading',
    description: 'Absorb information, expand vocabulary, and understand complex ideas. Critical reading helps you analyze and evaluate texts effectively.',
    icon: (
  ...
  {
    title: 'Listening',
    description: 'Actively process and comprehend spoken information. Effective listening is crucial for lectures, discussions, and multimedia learning.',
    icon: (
       <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    title: 'Writing',
    description: 'Organize thoughts, articulate complex concepts, and solidify your understanding. Writing is a powerful tool for thinking and learning.',
    icon: (
       <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    title: 'Speaking',
    description: 'Articulate your knowledge and engage in discussions. Explaining concepts to others is a proven way to deepen your own understanding.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
